...
public class GraphicsPurposeAssemblyComponentsSelectorFactory implements AssemblyComponentsSelectorFactory {
    ...
    public GraphicsPurposeAssemblyComponentsSelectorFactory create(BUDGETCATEGORY budget){
        switch (budget){
            case HIGH:
