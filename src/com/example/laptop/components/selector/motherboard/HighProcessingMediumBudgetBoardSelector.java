...
public class HighProcessingMediumBudgetBoardSelector implements AssemblyComponentsFamilySelector {
    ...
    public AssemblyComponent selectCompatibleAssemblyComponents(AssemblyComponent assemblyComponent){
        ...
        AssemblyComponent cpu = componentInventory.findByComponentIdentifier("AMDRyzen7");
        compositeAssembly.addToAssembly(cpu);
        List<AssemblyComponent> compatibleComponents = cpu.findCompatibleAssemblyComponentsByFamilyAndByBudget(cpu.getFamily(),BUDGETCATEGORY.HIGH);
