...
public class MediumProcessingLowBudgetBoardSelector implements AssemblyComponentsFamilySelector {
    ...
    public AssemblyComponent selectCompatibleAssemblyComponents(AssemblyComponent assemblyComponent){
        ...
        AssemblyComponent cpu = componentInventory.findByComponentIdentifier("AMDRyzen5");
        compositeAssembly.addToAssembly(cpu);
        List<AssemblyComponent> compatibleComponents = cpu.findCompatibleAssemblyComponentsByFamilyAndByBudget(cpu.getFamily(),BUDGETCATEGORY.LOW_TO_MEDIUM);
