...
public class MediumResolutionBigScreenSelector implements AssemblyComponentsFamilySelector {
    ...
    public AssemblyComponent selectCompatibleAssemblyComponents(AssemblyComponent assemblyComponent){
        ...
        List<AssemblyComponent> compatibleComponents = assemblyComponent.findCompatibleAssemblyComponentsByFamilyAndByBudget(ASSEMBLYCOMPONENTTYPE.GRAPHICS_ASSEMBLY,BUDGETCATEGORY.MEDIUM);
